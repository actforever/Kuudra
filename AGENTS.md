...
- Plugin archive scan `plugin.scan.started/completed`, successful startup stages `plugin.initialized/starting/active`, and normal shutdown stage details are DEBUG diagnostics; keep them out of the default INFO log. Do not lower top-level App stop boundaries, drain timeouts, or failures.
