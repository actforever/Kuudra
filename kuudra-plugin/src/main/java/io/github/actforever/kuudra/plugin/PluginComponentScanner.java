...
final class PluginComponentScanner {
    ...
    private java.util.Optional<PluginComponentDefinition> definition(String pluginId, String namespace, Class<?> type) {
        if (type.isAnnotationPresent(io.github.actforever.kuudra.plugin.annotation.SignalSource.class)) return component(pluginId, namespace, PluginComponentKind.SIGNAL_SOURCE, type.getAnnotation(io.github.actforever.kuudra.plugin.annotation.SignalSource.class).value(), type);
        if (type.isAnnotationPresent(io.github.actforever.kuudra.plugin.annotation.RootSignalSource.class)) return component(pluginId, namespace, PluginComponentKind.ROOT_SIGNAL_SOURCE, type.getAnnotation(io.github.actforever.kuudra.plugin.annotation.RootSignalSource.class).value(), type);
        if (type.isAnnotationPresent(io.github.actforever.kuudra.plugin.annotation.RawSignalProcessor.class)) return component(pluginId, namespace, PluginComponentKind.RAW_SIGNAL_PROCESSOR, type.getAnnotation(io.github.actforever.kuudra.plugin.annotation.RawSignalProcessor.class).value(), type);
        if (type.isAnnotationPresent(io.github.actforever.kuudra.plugin.annotation.SignalProcessor.class)) return component(pluginId, namespace, PluginComponentKind.SIGNAL_PROCESSOR, type.getAnnotation(io.github.actforever.kuudra.plugin.annotation.SignalProcessor.class).value(), type);
        if (type.isAnnotationPresent(io.github.actforever.kuudra.plugin.annotation.SessionProcessor.class)) return component(pluginId, namespace, PluginComponentKind.SESSION_PROCESSOR, type.getAnnotation(io.github.actforever.kuudra.plugin.annotation.SessionProcessor.class).value(), type);
        if (type.isAnnotationPresent(io.github.actforever.kuudra.plugin.annotation.SignalAdapter.class)) return component(pluginId, namespace, PluginComponentKind.SIGNAL_ADAPTER, type.getAnnotation(io.github.actforever.kuudra.plugin.annotation.SignalAdapter.class).value(), type);
