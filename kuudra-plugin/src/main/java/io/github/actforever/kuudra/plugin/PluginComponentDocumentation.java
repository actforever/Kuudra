...
public record PluginComponentDocumentation(String purpose, boolean lifecycle,
    ...
    public PluginComponentDocumentation(String purpose, boolean lifecycle,
                                        List<String> lifecyclePhases, List<String> supportedDesiredStates,
                                        List<PluginEventDocumentation> emittedEvents) {
        this(purpose, lifecycle, lifecyclePhases, supportedDesiredStates, List.of(), emittedEvents);
    }
    ...
    public PluginComponentDocumentation(String purpose, boolean lifecycle,
        ...
        this(purpose, lifecycle, lifecyclePhases,
