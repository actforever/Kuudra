...
public final class PluginController {
    ...
    KuudraApp.Plugin plugin(@PathVariable String namespace, @PathVariable String pluginId) {
    ...
    KuudraApp.ResourceTemplate resourceTemplate(@PathVariable String type, @PathVariable String namespace,
                                                 @PathVariable String pluginId, @PathVariable String name) {
